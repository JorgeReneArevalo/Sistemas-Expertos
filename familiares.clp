...
(hombre ?hijo1)
=>
(assert (primo-de ?hijo1 ?hijo2))
(printout t ?hijo1 " es primo de " ?hijo2 crlf)
)
...
(mujer ?hijo1)
=>
(assert (prima-de ?hijo1 ?hijo2))
(printout t ?hijo1 " es prima de " ?hijo2 crlf)
)
...
(hombre Maxs)
(mujer Michelle)
(progenitor-de Jorge Ricardo)
(progenitor-de Mario Maxs)
...
(progenitor-de Alejandro Michelle)
)
